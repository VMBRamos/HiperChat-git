...
namespace HiperChat.Models
{
    public class RespostaChatsController : Controller
    {
        ...
        /// <summary>
        /// API do chat pra pegar o input de mensagem e verificar com o banco se existe ou não a mensagem -- TÁ DANDO PAU COM O JS :( VERIFICAR ZZZZZZZZZZZZZZZZZ
        /// </summary>

        [HttpPost("api/Chat")]
        public async Task<JsonResult> Chat(RequestApi request)
        {   /// toUpper para não ter problema com o case da palavra
            ...
            if (respostaChat != null)
            {
                /// se a resposta diferente de null, ele acessa o banco e encontra o resultado fixo e retorna
            ...
            {
                var resposta = new ResponseApi { Resposta = "Não entendi, poderia reformular por gentileza? :)" };
                return Json(resposta);
            }
        }
